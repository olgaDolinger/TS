...
import { createCustomer, createCustomerID, getAllBooks, getBookByID, getBooksbyCategory, getBooksByCategoryPromice, getProperty, logCategotySearch, logFirstAvailable, logSearchResults, printRefBook, purge, сheckoutBooks } from './functions';
